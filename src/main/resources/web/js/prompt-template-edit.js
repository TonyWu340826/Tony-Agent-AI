    ...
    return React.createElement(
      ...
      React.createElement('div', { className: 'grid grid-cols-1 md:grid-cols-2 gap-3' },
          React.createElement('div', { className:'space-y-1' },
            React.createElement('div', { className:'text-sm text-gray-700' }, '场景编码'),
            React.createElement('select', { className:'border border-gray-300 rounded-lg px-3 py-2 w-full', value:form.scene_code, onChange:e=>setForm({ ...form, scene_code:e.target.value }) },
          ...
          React.createElement('div', { className:'space-y-1' },
            React.createElement('div', { className:'text-sm text-gray-700' }, '模型类型'),
          ...
          React.createElement('div', { className:'space-y-1' },
            React.createElement('div', { className:'text-sm text-gray-700' }, '版本号'),
            React.createElement('input', { className:'border border-gray-300 rounded-lg px-3 py-2 w-full', placeholder:'版本号', value:form.version, onChange:e=>setForm({ ...form, version:e.target.value }) })
          ),
          React.createElement('div', { className:'space-y-1' },
            React.createElement('div', { className:'text-sm text-gray-700' }, '角色类型'),
            React.createElement('select', {
              className:'border border-gray-300 rounded-lg px-3 py-2 w-full',
          ...
          React.createElement('div', { className:'space-y-1 md:col-span-2' },
            React.createElement('div', { className:'text-sm text-gray-700' }, '模板名称'),
            React.createElement('input', { className:'border border-gray-300 rounded-lg px-3 py-2 w-full', placeholder:'模板名称', value:form.template_name, onChange:e=>setForm({ ...form, template_name:e.target.value }) })
          ),
            React.createElement('div', { className:'md:col-span-2 space-y-1' },
            React.createElement('div', { className:'flex items-center justify-between' },
              React.createElement('div', { className:'text-sm text-gray-700' }, '提示词内容'),
              React.createElement('div', { className:'flex items-center gap-2' },
                React.createElement('select', { className:'border border-gray-300 rounded-lg px-2 py-1 text-sm', value:'', onChange:(e)=>{ const nm=e.target.value; insertVarToken(nm); e.target.value=''; } },
                ...
                React.createElement('button', { className:'text-purple-600 text-sm', onClick:openOptimize }, '使用AI优化')
              )
            ),
              React.createElement('textarea', {
                ...
                className:'border border-gray-300 rounded-lg px-3 py-2 w-full',
                rows:6,
                placeholder:'请输入提示词内容，可使用 {name} 或 {{name}} 定义变量',
              ...
              React.createElement('div', { className:'space-y-3 max-h-64 overflow-y-auto' },
                vars.map((v, idx) => React.createElement('div', { key:idx, className:'grid grid-cols-1 md:grid-cols-4 gap-3 items-start' },
                    ...
                    React.createElement('input', { className:'border border-gray-300 rounded-lg px-3 py-2', placeholder:'变量描述，例如: 用户名称', value:v.label || '', onChange:e=>updateVar(idx,'label',e.target.value) }),
                      React.createElement('select', { className:'border border-gray-300 rounded-lg px-3 py-2', value:v.type || 'string', onChange:e=>updateVar(idx,'type',e.target.value) },
